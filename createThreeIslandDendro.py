...
result = requests.get(basepath + "1")

cutoffs = [5, 18, 25.16, 55.25, 84, 96]
...
for percentage in cutoffs:
    ...
    plt.title(f'Dendrogram for Three Islands at {percentage}%')
    plt.xlabel('Data points')
    plt.ylabel('Distance between clusters')
    plt.ylim(0, 15)
    plt.savefig('C:/Users/SirMopf/Desktop/plots/threeislands/Dendrogram at ' + str(percentage) +'.png')
    plt.show()
    ...
    plt.xlim(0, 15)
    plt.savefig('C:/Users/SirMopf/Desktop/plots/threeislands/Dendrogram at ' + str(percentage) +' Full.png')
    plt.show()